...
{
    class KeyboardWrapperContext : ApplicationContext
    {
        private KeyboardManager manager;

        private KeyboardWrapper form;
        ...
        public KeyboardWrapperContext()
        {
            manager = new KeyboardManager();

            if (manager.Setup())
            {
                form = new KeyboardWrapper(manager);
            }
            else
            {
        ...
        private void InitializeComponent()
        {
            ...
            TrayIcon.Text = "KeyboardWrapper";

            TrayIcon.Icon = Properties.Resources.ProgrammaticKeyboardWrapper;
            ...
            this.TrayIconContextMenu.Name = "KeyboardWrapper";
            ...
            this.CloseMenuItem.Text = "Close KeyboardWrapper";
        ...
        {
            if (MessageBox.Show("Are you sure you want to close KeyboardWrapper?",
                    "Close KeyboardWrapper?", MessageBoxButtons.YesNo, MessageBoxIcon.Exclamation,
